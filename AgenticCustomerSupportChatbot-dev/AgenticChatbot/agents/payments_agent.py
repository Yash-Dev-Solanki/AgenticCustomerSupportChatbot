...
CUSTOM_PROMPT = """
You are an expert assistant specializing in Payments documents.
...
def payments_tool(
    ...
    """
        ...
        Args:
            question (str): The payment-related question to answer.
    ...
    """
    print(f"Payments tool received question: {question}")
    
    # Get the answer from the QA chain
    answer = ask_payments(question)
...
def create_payments_agent() -> CompiledGraph:
    return create_react_agent(
        model=model,
        tools=[payments_tool],
        prompt = """You are a payments expert agent. For every payment-related question, ALWAYS call the payments_tool with the question as input.
        Never answer directly. Always delegate to the payments_tool.
        """,
        name="payments_agent",
