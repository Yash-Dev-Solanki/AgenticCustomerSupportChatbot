...
def build_model() -> CompiledGraph:
    ...
    members = ["validation_agent", "update_agent", "query_agent", "payments_agent"]
    supervisor_agent = get_supervisor_agent(members= members)

    supervisor = (
        StateGraph(GraphState)
        .add_node(supervisor_agent, destinations= ("validation_agent", "update_agent", "query_agent","payments_agent", END))
